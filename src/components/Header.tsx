...
const Header: React.FC<HeaderProps> = ({ backgroundColor }) => {
  ...
  return (
    <LinearGradient
      colors={backgroundColor ? [backgroundColor, backgroundColor, backgroundColor] : ['#ffffff', '#ffffff', '#ffffff']}
      style={styles.headerContainer}
    >
      {/* Left Logo Section */}
      <View style={styles.logoContainer}>
        <Image
          source={icons.HeaderLeftLogo as ImageSourcePropType} // Replace with your logo path
          style={styles.logo}
          resizeMode="contain"
        />
      ...
      <View style={styles.iconContainer}>
        <TouchableOpacity style={styles.iconButton}>
          <Image
            source={icons.NotificationIcon as ImageSourcePropType} // Replace with your notification icon path
            style={styles.icon}
            resizeMode="contain"
          />
        </TouchableOpacity>
        ...
        >
          <Image
            source={icons.HeaderBarIcon as ImageSourcePropType} // Replace with your menu icon path
            style={styles.icon}
            resizeMode="contain"
          />
        </TouchableOpacity>
